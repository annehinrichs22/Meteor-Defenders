...
// Now available with BT support!
// Super AWESOME!!!
// Im sorry for the messy code...
// And for all the Dutch all over the place
// And for being too lazy to remove it and for using one line comments only.
// You should use the app called "Bluetooth RC Controller" in the send when change mode.
// Also im gonna try ascii art. Yeah.
/*
 *    _________      ________
 *   /         \    /        \
 *  /           \  /     |    \
 ...
 * \            /  \     |   /
 *  \__________/    \_______/
 *  In case you didn't notice, it's the Arduino logo.
 */
